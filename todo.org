...
** TODO Medication labeler [2/10] [20%]
   - [ ] Generic text for dental meds
   - [ ] Display current printer selected for printing
   - [ ] Generic user permissions (op-wlws, op-rblf)
   ...
   - [ ] Install Cohasset dental label printer
   - [ ] Install Red Bluff dental label printer
   - [ ] Install for Rachelle Romano
...
** TODO Miscellaneous [0/2] [0%]
   - [ ] Dr Austin direct EBO link
   - [ ] Medication labeler on wlws-lptp-0265 for Diana
