...
** TODO Sacramento router swap [5/6] [83%]
   - [X] To bring:
     - [X] manjaro laptop
   ...
   - [ ] Write the non-critical config
   - [X] Confirm NOSC TACACS login
** TODO Medication labeler [0/2] [0%]
   - [ ] Generic text for dental meds
   - [ ] Display current printer selected for printing

** TODO IHS network scanning/slowdown investigation [1/3] [33%]
   - [ ] Pull Brandi's packet capture
   - [X] Block known IHS scanning networks at router level
   - [ ] Talk to Dan Grinnell at IHS about ForeScout meeting
