...
let g_which_key_map =  {}
let g_which_key_map['name'] = 'space-vim root'

for s:i in range(1, 9)
  let g_which_key_map[s:i] = 'window-'.s:i
endfor
unlet s:i

let g_which_key_map['?'] = [ 'Maps', 'show-keybindings' ]
let g_which_key_map[';'] = [ '<Plug>NERDCommenterToggle','commenter' ]
let g_which_key_map[' '] = {
      \ 'name': '+tab' ,
      \ '1' : 'tab-1'  ,
      \ '2' : 'tab-2'  ,
...
let g_which_key_map['a'] = {
      \ 'name' : '+align',
      \ }

let g_which_key_map['b'] = {
      \ 'name' : '+buffer'       ,
      \ '1' :  'buffer-1'        ,
      \ '2' :  'buffer-2'        ,
      \ '3' :  'buffer-3'        ,
...
let g_which_key_map['d'] = 'scroll-down'

let g_which_key_map['e'] = {
      \ 'name' : '+errors'     ,
      \ 'n' : 'next-error'     ,
      \ 'p' : 'previous-error' ,
      \ }

let g_which_key_map['f'] = {
...
let g_which_key_map['h'] = {
      \ 'name' : '+help',
      \ }

let g_which_key_map['j'] = {
      \ 'name' : '+jump/json'                   ,
...
let g_which_key_map['r'] = {
      \ 'c' : 'replace-current-word-in-current-file',
      \ }

let g_which_key_map['q'] = [ 'q', 'quit' ]

let g_which_key_map['Q'] = [ 'qa!', 'quit-without-saving' ]

let g_which_key_map['s'] = {
      \ 'name' : '+search/show'                        ,
...
let g_which_key_map['u'] = 'scroll-up'

let g_which_key_map['w'] = {
      \ 'name' : '+windows'                       ,
      \ 'w' :  'other-window'                     ,
      \ 'd' :  'delete-window'                    ,
      \ '-' :  'split-window-below'               ,
...
let g_which_key_map['x'] = {
      \ 'name' : '+text'           ,
      \ 'a' : ['<Plug>(EasyAlign)' , 'easy-align']                 ,
      \ 'd' : ['StripWhitespace'   , 'delete-trailing-whitespace'] ,
      \ }

let g:spacevim#map#leader#desc =  get(g:, 'spacevim#map#leader#desc', g_which_key_map)
